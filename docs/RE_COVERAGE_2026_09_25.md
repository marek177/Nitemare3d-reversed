# Nite3W / Nitemare 3D RE coverage ledger — 2026-09-25
...
The corresponding machine-readable coverage table is in:

`src/re/N3DAnalysisStatus_2026_09_25.hpp`

The gameplay-core reconstruction remains in:

`src/re/N3DRecoveredCore_2026_09_25.hpp/.cpp`

Coverage values are intentionally separated from gameplay code so that changing an estimate cannot silently alter reconstructed behavior.
