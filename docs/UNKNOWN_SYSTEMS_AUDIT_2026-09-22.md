...
| 35 | **USER.SAV – fyzický layout potvrdený; C553 sémantika čiastočne vyriešená.** Osem bajtov je rozdelených na dverový selector bitfield, guard režim, trigger/story stavy a dočasný shade/update režim. | Zostáva 94-bajtový blok hráča/globálneho stavu, 64-bajtové wake cache indexy a rebasing timerov/pointerov cez zmenu levelu. |
